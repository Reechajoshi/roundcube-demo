...
$config['db_mailx'] = 'mysql://mailx:mailx@localhost/mailx';
$config['db_calendar'] = 'mysql://calendar:calendar@localhost/calendar';
...
// $config['support_url'] = '';
$config['support_url'] = 'https://mail.mgtech.in/'; 
...
$config['log_dir'] = '/var/www/webmail/logs/'; 
...
$config['des_key'] = 'yDBRi!f&f&H*x6XcCz%D4BQT'; 
...
$config['product_name'] = 'Macgregor Mail';

// Add this user-agent to message headers when sending
$config['useragent'] = 'Macgregor Webmail/'.RCMAIL_VERSION;
...
$config['plugins'] = array( 'plugin_manager', 'dovecot_ident', 'additional_message_headers' ); 
...
// Macgregor Changes
//for changing password in admin tab
$config['admin_pass'] = '';
$config['confirm_admin_pass'] = '';
$config['current_admin_pass'] = '';

//for out of office menu
$config['out_of_office_enable'] = '';
$config['out_of_office_subject'] = '';
$config['out_of_office_message'] = '';

//for block email menu
$config['blockEmail_header'] = 0;
$config['blockEmail_filter'] = '';

//for forward rule menu
$config['forwardRule_header'] = 0;
$config['forwardRule_filter'] = '';
$config['forwardRule_email'] = '';

//for custom directive
$config['custom_rule_enable'] = '';
$config['custom_rule_desc'] = '';

// for archive
$config['global_archive'] = 'mail';

$config['is_admin'] = true;
$config['is_admin_multiple'] = true;
$config['is_super_admin'] = true;

// end of config file
$config['super_admin'] = array( 'jamie@mgtech.in', 'richa@mgtech.in' );
// end of config file
