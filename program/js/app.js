...
function rcube_webmail()
{
  ...
  this.init = function()
  {
    ...
    switch (this.task) {
      ...
      case 'settings':
        ...
        /** MACGREGOR CHANGES **/
		// to enable the command specified in func.inc, the command is specified in this line
        this.enable_command('preferences', 'identities', 'responses', 'save', 'folders' , 'admin', 'rules', 'manage', 'superadmin', true);
        ...
        /** MACGREGOR CHANGES **/
		/* ADMIN SUBMENU CLICKABLE */
		else if(this.gui_objects.adminlist) {
			this.admin_list = new rcube_list_widget(this.gui_objects.adminlist, {multiselect:false, draggable:false, keyboard:false});
			this.admin_list
			.addEventListener('select', function(o) { ref.admin_select(o); })
			.init()
			.focus();
		}
		/* RULES SUBMENU CLICKABLE */
		else if(this.gui_objects.ruleslist) {
			this.rules_list = new rcube_list_widget(this.gui_objects.ruleslist, {multiselect:false, draggable:false, keyboard:false});
			this.rules_list
			.addEventListener('select', function(o) { ref.rules_select(o); })
			.init()
			.focus();
		}
		/* MANAGE SUBMENU CLICKABLE */
		else if(this.gui_objects.managelist) {
			this.manage_list = new rcube_list_widget(this.gui_objects.managelist, {multiselect:false, draggable:false, keyboard:false});
			this.manage_list
			.addEventListener('select', function(o) { ref.manage_select(o); })
			.init()
			.focus();
		}
		/* SUPERADMIN SUBMENU CLICKABLE */
		else if(this.gui_objects.superadminlist) {
			this.superadmin_list = new rcube_list_widget(this.gui_objects.superadminlist, {multiselect:false, draggable:false, keyboard:false});
			this.superadmin_list
			.addEventListener('select', function(o) { ref.superadmin_select(o); })
			.init()
			.focus();
		}
        break;
  ...
  this.command = function(command, props, obj, event)
  {
    ...
    switch (command) {
      ...
      /** MACGREGOR CHANGES **/
	  /* TO MAKE MENU CLICKABLE WRITE THE COMMAND IN THIS CASE */
      case 'preferences':
      case 'identities':
      case 'responses':
      case 'folders':
...
//        onSelect: function(dateText) { $(this).focus().val(dateText); }
  ...
  /*********************************************************/
  /* ADMIN */
  this.admin_select = function(list)
  {
    var win, id = list.get_single_selection(), target = window,
      url = {_action: 'edit-admin', _admin: id};
  ...
  /* RULES */
  this.rules_select = function(list)
  {
    var win, id = list.get_single_selection(), target = window,
      url = {_action: 'edit-rules', _rules: id};
  ...
  /* MANAGE */
  this.manage_select = function(list)
  {
    var win, id = list.get_single_selection(), target = window,
      url = {_action: 'edit-manage', _manage: id};
  ...
  /* SUPERADMIN */
  this.superadmin_select = function(list)
  {
    var win, id = list.get_single_selection(), target = window,
      url = {_action: 'edit-superadmin', _superadmin: id};
